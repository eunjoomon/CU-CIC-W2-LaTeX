...
\title{The Future and Risdks of FLoC*\\
{\footnotesize \textsuperscript{*}Note: A research of cookies and 
privacy threats for next-generation advertising}
% \thanks{Identify applicable funding agency here. If none, delete this.}
}

\author{\IEEEauthorblockN{1\textsuperscript{st} Heetak Yang (Leslie)}
\IEEEauthorblockA{\textit{Bachelor Of Science With Honours In Cyber Security} \\
\textit{Coventry University (CU.)}\\
City, Country \\
leselsey@outlook.com}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Seohyun Lee}
\IEEEauthorblockA{\textit{Bachelor Of Science With Honours In Cyber Security} \\
\textit{Coventry University (CU.)}\\
City, Country \\
sshyunleee0000@gmail.com}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Sanghyup Lee}
\IEEEauthorblockA{\textit{Bachelor of Science with Honours in Computing Science} \\
\textit{Coventry University (CU.)}\\
City, Country \\
email address or ORCID}
\and
\IEEEauthorblockN{4\textsuperscript{th} Eunjoo Lee}
\IEEEauthorblockA{\textit{Bachelor of Science with Honours in Computing Science} \\
\textit{Coventry University (CU.)}\\
City, Country \\
92454273l@gmail.com}
\and
\IEEEauthorblockN{5\textsuperscript{th} Soyoung Yoon}
\IEEEauthorblockA{\textit{Bachelor of Science with Honours in Computing Science} \\
\textit{Coventry University (CU.)}\\
City, Country \\
email address or ORCID}
\and
\IEEEauthorblockN{6\textsuperscript{th} Chaemin Sung}
\IEEEauthorblockA{\textit{Bachelor of Science with Honours in Computing Science} \\
\textit{Coventry University (CU.)}\\
City, Country \\
email address or ORCID}
...
\begin{itemize}
    ...
    quotation marks are used, instead of a bold or italic typeface, to 
    highlight a word or phrase, punctuation should appear outside of the 
    quotation marks. A parenthetical phrase or statement at the end of a 
    ...
    \item The prefix ``non'' is not a word; it should be joined to the word 
